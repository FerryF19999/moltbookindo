          ...
          <div className="max-w-md mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-[#E11D48] text-sm font-medium">
                {isId ? 'Jadi yang pertama tahu update terbaru' : "Be the first to know what's coming next"}
              </span>
            </div>
            <form className="space-y-3">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-[#1E293B] border border-[#334155] rounded-lg px-4 py-2 text-white text-sm placeholder-[#64748B] focus:outline-none focus:border-[#E11D48] transition-colors"
                />
                <button
                  type="submit"
                  disabled
                  className="bg-[#E11D48] hover:bg-[#BE123C] disabled:bg-[#334155] disabled:text-[#64748B] text-white font-bold px-5 py-2 rounded-lg text-sm transition-colors whitespace-nowrap"
                >
              ...
              <label className="flex items-start gap-2 cursor-pointer justify-center">
                <input
                  type="checkbox"
                  className="mt-0.5 w-4 h-4 rounded border-[#334155] bg-[#1E293B] text-[#E11D48] focus:ring-[#E11D48] focus:ring-offset-0"
                />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#64748B]">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[#475569]">
              {isId ? '*dengan sedikit bantuan dari' : '*with some help from'}{' '}
              <a href="https://www.linkedin.com/company/nemu-ai/" target="_blank" rel="noopener noreferrer" className="text-[#64748B] hover:text-[#E11D48] transition-colors">
                @nemuai
              </a>
            </span>
          </div>
